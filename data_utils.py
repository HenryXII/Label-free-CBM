...
DATASET_ROOTS = {
    "imagenet_train": "/datasets/imagenet-ilsvrc2012/",
    "imagenet_val": HOME+"data",
    "cub_train":HOME+"data/CUB/train",
    "cub_val":HOME+"data/CUB/test"
}
...
def get_data(dataset_name, preprocess=None):
    if dataset_name == "cifar100_train":
        ...
        data=datasets.ImageNet(DATASET_ROOTS[dataset_name], split='val', transform=preprocess)
    elif dataset_name == "imagenet_train":
        data = datasets.ImageFolder(
            root=os.path.join(DATASET_ROOTS[dataset_name], 'training'),
            transform=preprocess
        )
